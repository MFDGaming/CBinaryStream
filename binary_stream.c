...
{
	uint64_t value = ((unsigned long long) (stream->buffer[stream->offset] & 0xff));
	++stream->offset;
...
{
	uint64_t value = ((unsigned long long) (stream->buffer[stream->offset] & 0xff)) << ((unsigned long long) 56);
	++stream->offset;
	value |= ((unsigned long long) (stream->buffer[stream->offset] & 0xff)) << ((unsigned long long) 48);
	++stream->offset;
	value |= ((unsigned long long) (stream->buffer[stream->offset] & 0xff)) << ((unsigned long long) 40);
