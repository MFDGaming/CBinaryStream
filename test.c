...
int main () {
    ...
    put_unsigned_long_le((uint64_t)18446744073709551614, &stream);
    put_unsigned_long_be((uint64_t)18446744073709551614, &stream);
    ...
    put_var_long((uint64_t)18446744073709551614, &stream);
